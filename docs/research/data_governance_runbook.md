...
- Factor 008B blocker count: `11`
- Factor 008B next action: clear short-history/manual-review/no-used-factor blockers, then rerun build-candidate-gate
- Index 007B readiness status: `ready_small_scope`
- Index 007B scope: `small_scope`
- Index 007B full-scope available: `NO`
- Index 007B blocker count: `0`
- Index 007B next action: enter 007B only for ETFs with confirmed benchmark metrics; keep warning rows out of full-scope work
- ETF 007B metrics status: `ok`
- ETF 007B metrics scope: `small_scope`
- ETF 007B computable count: `6`
- ETF 007B full-scope available: `NO`
- ETF 007B next action: keep ETF-GAP-007B as a research-only small-scope report; do not connect to factor_score or candidate_gate
...
- `etf_007b_metrics_report`: `output\etf_007b_metrics_report.csv`
- `etf_007b_metrics_summary`: `output\etf_007b_metrics_summary.csv`
